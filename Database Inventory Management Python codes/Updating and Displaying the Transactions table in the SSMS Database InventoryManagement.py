...
def update_transactions_table(conn, cursor, product_list, supplier_list):
    ...
    product_name = get_input("Enter ProductName: ", str)
    ...
    supplier_name = get_input("Enter SupplierName: ", str)
    ...
    transaction_type = get_input("Enter TransactionType (In/Out): ", str).capitalize()
