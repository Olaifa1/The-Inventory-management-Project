    ...
    def add_new_supplier(self, updated_supplier_list):
        while True:
            try:
                ...
                new_supplier_name = new_supplier_name.title() # Convert to Title case

                # Check if new_supplier_name contains only English alphabets in sentence case
                if not re.match("^[A-Za-z]+( [A-Za-z]+)*$", new_supplier_name):
                    raise ValueError("new_supplier_name must contain only English alphabets.")
    ...
    def change_supplier_name(self, updated_supplier_list):
        ...
        while True:
            try:
                ...
                old_supplier_name = old_supplier_name.title() # Convert to Title case
                ...
                while True:
                    ...
                    # Check if new_supplier_name contains only English alphabets in sentence case
                    if not re.match("^[A-Za-z]+( [A-Za-z]+)*$", new_supplier_name):
                        print("New Supplier name must contain only English alphabets and have only one space between words.")
                        continue
