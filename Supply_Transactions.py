...
# Create an instance of the SupplyTransactions class
supply_transactions = SupplyTransactions(connection_string)

# Run the program using the instance
supply_transactions.run_program()
# Create an instance of the SupplyTransactions class and execute the main program loop
